...
const mockCartItems = [
  { productId: '1', name: 'Pâine Albă', price: 10, quantity: 2, weight: '500g', productType: 'paine', slug: 'paine-alba' },
  { productId: '2', name: 'Scovergă', price: 10, quantity: 1, weight: '300g', productType: 'produs', slug: 'scoverga' },
]
