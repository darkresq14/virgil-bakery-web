...
import { BRAND_NAME, SITE_DESCRIPTION } from './seoDefaults';
...
export const generateMeta = async (args: {
  ...
  // Avoid duplicating the brand when an editor already includes it in the
  // meta-title field — otherwise titles render as "... | Brand | Brand".
  const title = rawTitle
    ? rawTitle.toLowerCase().includes(BRAND_NAME.toLowerCase())
      ? rawTitle
      : `${rawTitle} | ${BRAND_NAME}`
    : BRAND_NAME;
